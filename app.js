...
// Object created: randomFunct{} with 4 key: value pairs, to store all generator functions
const randomFunc = {
...
generateEl.addEventListener(`click`, () => {
    ...
    const length = parseInt(lengthEl.value);
            // Changing value from a "string" to a number using parseInt() and setting to variable, const length
